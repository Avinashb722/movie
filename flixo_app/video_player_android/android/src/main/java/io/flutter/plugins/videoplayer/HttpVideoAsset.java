...
final class HttpVideoAsset extends VideoAsset {
  public static final java.util.Map<String, HttpVideoAsset> activeAssets = new java.util.concurrent.ConcurrentHashMap<>();

  public static HttpVideoAsset getActiveAsset(String url) {
    if (url == null) return null;
    return activeAssets.get(url);
  }

  public static void removeActiveAsset(String url) {
    if (url != null) {
      activeAssets.remove(url);
    }
  }
  ...
  HttpVideoAsset(
    ...
    if (assetUrl != null) {
      activeAssets.put(assetUrl, this);
    }
  }
