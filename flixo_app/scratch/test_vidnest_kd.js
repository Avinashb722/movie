/**
 * Test all Vidnest providers for KD to find other working languages
 */
...
async function test() {
  const providers = [
    '/moviesapi/movie/1103473',
    '/allmovies/movie/1103473',
    '/moviebox/movie/1103473',
    '/movies5f/movie/1103473'
  ];

  for (const p of providers) {
    const url = 'https://new.vidnest.fun' + p;
    ...
    if (res.status === 200) {
      try {
        ...
        console.log(`Decrypted data:`, JSON.stringify(data, null, 2).substring(0, 1000));
      } catch (e) {
