/**
 * Print decrypted Vidnest API response for KD
 */
...
function printKD() {
  https.get('https://new.vidnest.fun/moviesapi/movie/1103473', {
    headers: {
    ...
    res.on('end', () => {
      try {
        ...
        console.log('--- MOVIESAPI Response ---');
  ...
  https.get('https://new.vidnest.fun/allmovies/movie/1103473', {
    headers: {
      'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36',
      'Referer': 'https://vidnest.fun/',
      'Origin': 'https://vidnest.fun'
